...
export default function PricingPage() {
    ...
    const faqs = [
        ...
        { q: "Do you offer monthly retainers?", a: "Yes, beyond project-based work, we offer dedicated engineering retainers for continuous development and maintenance, starting at $5,000/month." },
